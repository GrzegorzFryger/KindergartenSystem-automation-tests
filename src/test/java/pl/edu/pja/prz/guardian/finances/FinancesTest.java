...
public class FinancesTest extends BaseAutomationTest {
    ...
    public void Should_VisitFinancesPanel() {
        ...
        driver.clickByXPath("/html/body/app-root/app-guardian/div/mat-card/div[1]/div/mat-card/div/div[2]/app-navbar/div/div[3]/div/button");
        // Balance amount
    ...
    public void Should_CheckChildBalance() {
        ...
        driver.clickByXPath("//*[@id=\"mat-expansion-panel-header-0\"]/span[2]");
        // Child Balance
        ...
        driver.clickByXPath("//*[@id=\"cdk-accordion-child-0\"]/div/div[2]/button");
        // Organization name
